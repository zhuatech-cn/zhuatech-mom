...
class EnterpriseControlApiTests {
    ...
    private static final String BODY="""
        {"controlNo":"ENT-MOM-001","organizationCode":"ZH-SH","fiscalPeriod":"2026-08",
         ...
         "externalRef":"","idempotencyKey":"idem-mom-enterprise-001"}
        """;
    ...
    @Test void invalidPeriodAndChecksumAreRejected() throws Exception {
        mvc.perform(post("/api/enterprise/controls").with(httpBasic("operator","operator123"))
            .contentType(MediaType.APPLICATION_JSON).content(BODY.replace("2026-08","2026-13").replace("ENT-MOM-001","ENT-MOM-BAD")))
