...
import cn.zhuatech.mom.domain.DomainCatalog;
...
public class MomService {
    ...
    public MomService(BusinessRecordRepository records,AuditLogRepository audits,SystemSettingRepository settings,DomainCatalog catalog){
